...
module.exports = function(params, callback) {
  ...
  sourceDb.keys(params.pattern, function(keysErr, keys) {
    if (keysErr) {
                  ...
                  case 'string':
                    ...
                    destinationDb.set(key, keyValue, function(err, reply) {
                      if (err) {
                        ...
                        result.written++;
                        console.log('string value written successfully.');
                        return next(null);
                      }
                    });
                    break;
                  case 'list':
                    ...
                    destinationDb.rpush([key].concat(keyValue), function(err, reply) {
                      if (err) {
                        ...
                        result.written++;
                        console.log('%d list values written successfully.', reply);
                        return next(null);
                      }
                    });
                    break;
                  case 'set':
                    ...
                    destinationDb.sadd([key].concat(keyValue), function(err, reply) {
                      if (err) {
                        ...
                        result.written++;
                        console.log('%d set values written successfully.', reply);
                        return next(null);
                      }
                    });
                  break;
                  case 'zset':
                    ...
                    destinationDb.zadd(arr, function(err, reply) {
                      if (err) {
                        ...
                        result.written++;
                        console.log('%d sorted set values written successfully.', reply);
                        return next(null);
                      }
                    });
                    break;
                    ...
                    if (params.overwrite === true) {
                      destinationDb.hmset(key, keyValue, function(err, reply) {
                        if (err) {
                          ...
                          result.written++;
                          console.log('%d hash field values written successfully.', Object.keys(keyValue).length);
                          return next(null);
                        }
                      });
                    } else {
                      ...
                      function(err) {
                        if (err) {
                          ...
                          if (hashValuesWritten === 0) {
                            console.log('0 hash field values written.');
                          } else {
                            result.written++;
                            console.log('%d of %d hash field values written successfully.', hashValuesWritten, Object.keys(keyValue).length);
                          }
                          return next(null);
                        }
                      });
